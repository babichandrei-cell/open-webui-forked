...
class Tools:
    ...
    async def _collect_reference_images(
        ...
        # Prefer the original Files Workspace attachment representation
        # over the transient multimodal data URL generated by Open WebUI.
        #
        # The same filesystem image can be visible through both __files__
        # and __messages__. Keeping the filesystem copy first preserves
        # accurate source metadata while SHA-256 deduplication removes the
        # duplicate multimodal representation.
        references.extend(
